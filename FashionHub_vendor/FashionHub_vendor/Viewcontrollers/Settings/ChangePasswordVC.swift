...
class ChangePasswordVC: UIViewController {
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    self.txt_OldPassword.placeHolderColor = .lightGray
    self.txt_NewPassword.placeHolderColor = .lightGray
    self.txt_ConfirmPassword.placeHolderColor = .lightGray
  }
  ...
  @IBAction func btnTap_Reset(_ sender: UIButton) {
    ...
    if self.txt_NewPassword.text! != self.txt_ConfirmPassword.text! {
      ...
      let urlString = "http://192.168.1.28/ecom-saas/api/changepassword"
