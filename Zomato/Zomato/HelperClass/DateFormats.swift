...
public let DATE_FORMAT1: String = "dd MMM, yyyy"
...
public let JOIN_DATE_FORMAT: String = "MM/dd/yyyy hh:mm a"
public let MONTHYEAR_DATE_FORMAT: String = "MMMM yyyy"
public let FB_BIRTH_DATE_FORMAT: String = "MM/dd/yyyy"
public let DIFF_DATE_FORMAT: String = "EEE dd MMM yyyy"
...
public let DAYETIME_DATE_FORMAT: String = "hh:mm a"
public let JOINGORUP_DATE_FORMAT: String = "MM/dd/yyyy"
...
class DateFormater {
  ...
  //MARK: Convert To Local TimeZone
   ...
   class func convertDateToLocalTimeZone(givenDate: String) -> String {
    ...
    class func convertCreateDateToString(givenDate: String) -> String {
         var final_date: String
         self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FORMAT1
     self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
         //SET TIME ZONE FORMAT OF SERVER HERE
         let ts_utc: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
         self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
    ...
    class func getStringFromDateStringJoin(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = JOIN_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.dateFormat = MONTHYEAR_DATE_FORMAT
        return self.sharedInstance.sharedDateFormat!.string(from: date as Date)
    }
    class func getStringFromDateStringFeed(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = JOIN_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.dateFormat = DAYETIME_DATE_FORMAT
        return self.sharedInstance.sharedDateFormat!.string(from: date as Date)
    }
    class func getStringFromDateStringGroupJoinDate(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = JOIN_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FOR_CHAT
        return self.sharedInstance.sharedDateFormat!.string(from: date as Date)
    }
    ...
    //MARK: Common Formats
    class func getStringFromDateString2(givenDate: String) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
        self.sharedInstance.sharedDateFormat!.dateFormat = FULL_DATE_FORMAT
        let date: NSDate = self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
        self.sharedInstance.sharedDateFormat!.dateFormat = DATE_FOR_CHAT
    ...
    {
        self.sharedInstance.sharedDateFormat!.timeZone = .current
        self.sharedInstance.sharedDateFormat!.dateFormat = JOIN_DATE_FORMAT
        return self.sharedInstance.sharedDateFormat!.date(from: givenDate)! as NSDate
    }
    ...
    class func getDateFromDate1(givenDate: NSDate) -> NSDate {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone(name: "UTC") as TimeZone?
        self.sharedInstance.sharedDateFormat!.dateFormat = ONLY_DATE_FORMAT
        let strDate: String = self.sharedInstance.sharedDateFormat!.string(from: givenDate as Date)
        self.sharedInstance.sharedDateFormat!.dateFormat = ONLY_DATE_FORMAT
    ...
    class func generateCurrentTimeForGivenDate(strDate: NSDate) -> String {
        self.sharedInstance.sharedDateFormat!.timeZone = NSTimeZone.system
